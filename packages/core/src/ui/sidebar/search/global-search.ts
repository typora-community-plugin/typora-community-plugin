...
export class GlobalSearch {
  ...
  openGlobalSearch(query: string) {
    ...
    // Use custom ripgrep-based search instead of native delegation
    this._startCustomSearch(view, vault.path, query)
  }

  /** Start a custom ripgrep-based global search. */
  private _startCustomSearch(view: GlobalSearchView, mountFolder: string, query: string): void {
